...
@section('search')
	<div class="position-relative mr-2">
		{!! Form::select('tone_id', $optionstone, ($tone ?? ''), ['class' => 'selectpicker', 'title' => 'Selecione uma Tonalidade']) !!}
	</div>
@endsection
	...
	<table class="align-middle mb-0 table table-borderless table-striped table-hover">
		<thead>
			<tr>
				...
				<th width="15%" class="text-center">Tonalidade</th>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-left">{!! $item->tone->name !!}</td>
