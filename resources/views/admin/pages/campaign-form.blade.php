...
<div class="app-page-title">
	<div class="page-title-wrapper">
		<div class="page-title-heading">
			...
			<div>
				Campanhas
				<div class="page-title-subheading">Formulário para cadastrar uma nova campanha.</div>
			</div>
		</div>
		<div class="page-title-actions">
			<div class="d-inline-block dropdown">
				<a href="{!! route('campaign.list') !!}" class="mb-2 mr-2 btn-transition btn btn-outline-focus">
...
<div class="row">
	<div class="col-md-12">
		{!! Form::open(['id' => 'form-campaign', 'route' => 'campaign.store', 'method' => 'POST', 'role' => 'form', 'class' => 'form']) !!}
			<div class="main-card mb-3 card">
				<div class="card-body"><h5 class="card-title">Preencha o formulário</h5>
					<div class="form-row">
						<div class="col-md-6">
							<div class="position-relative form-group">
								{!! Form::label('name', 'Nome do Campanha*') !!}
			...
			<div class="main-card mb-3 card">
				<div class="card-button">
					{!! Form::buttons('campaign.list', $data->id) !!}
				</div>
			</div>
		{!! Form::close() !!}
	</div>
