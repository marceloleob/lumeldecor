	...
	<div class="page-title-wrapper">
		<div class="page-title-heading">
			<div class="page-title-icon">
				<i class="fas fa-warehouse icon-gradient bg-plum-plate"></i>
			</div>
			<div>
				Estoque
				<div class="page-title-subheading">(ainda não está definido como vou fazer).</div>
			</div>
		</div>
		<div class="page-title-actions">
			<div class="d-inline-block dropdown">
				<a href="{!! route('stock.create') !!}" class="mb-2 mr-2 btn-transition btn btn-outline-primary">
		...
		<div class="col-md-12">
			<div class="main-card mb-3 card">
				<div class="card-header">Lista
					<div class="btn-actions-pane-right search">
						<div role="group" class="btn-group-sm btn-group">
							{!! Form::open(['id' => 'form-search', 'route' => 'stock.search', 'method' => 'POST', 'role' => 'group']) !!}
								<div class="custom-control custom-control-inline input-group">
									...
									<a href="{!! route('stock.list') !!}" class="btn btn-focus"><i class="fas fa-backspace pr-2 pl-2"></i> Limpar a busca</a>
								</div>
							{!! Form::close() !!}
						</div>
					</div>
				...
				<div class="table-responsive">
					@if (count($data))
						<table class="align-middle mb-0 table table-bstockless table-striped table-hover">
							<thead>
								<tr>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a href="{!! route('stock.edit', [$item->id, $data->currentPage()]) !!}" class="bstock-0 btn-transition btn btn-outline-primary"><i class="far fa-edit"></i></a>
										<a href="{!! route('stock.toggle', $item->id) !!}" class="bstock-0 btn-transition btn {!! $item->trash['class'] !!}"><i class="fas {!! $item->trash['label'] !!}"></i></a>
									</td>
								</tr>
								@endforeach
							</tbody>
...
@else
	<div class="row">
		<div class="col-md-12">
			<div class="main-card mb-3 card">
				<div class="card-no-records">
					Ainda não existe nenhum "Estoque" cadastrado.
				</div>
			</div>
		</div>
	</div>
