							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a href="{!! route('category.edit', [$item->id, $data->currentPage()]) !!}" class="border-0 btn-transition btn btn-outline-primary"><i class="far fa-edit"></i></a>
										<a href="{!! route('category.toggle', $item->id) !!}" class="border-0 btn-transition btn {!! $item->trash['class'] !!}"><i class="fas {!! $item->trash['label'] !!}"></i></a>
									</td>
								</tr>
								@endforeach
							</tbody>
