...
@section('heading')
	...
	<div>
		Cupons de Desconto
		<div class="page-title-subheading">Formulário para editar o cupom de desconto do site.</div>
	</div>
@stop
						...
						<div class="form-row">
							<div class="col-md-6">
								...
								<div class="position-relative form-group">
									...
									{!! Form::text('code', old('code', $data->code), ['class' => 'form-control text input-coupon uppercase']) !!}
