					...
					<div class="form-row">
						...
						<div class="col-md-3">
							<div class="position-relative form-group">
								...
								<div class="input-group">
									{!! Form::text('weight[]', old('weight[]'), ['class' => 'form-control decimalOnly']) !!}
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card-piece mt-3 mb-3">
								<div class="card-body"><h5 class="card-title">Informações das Peças</h5>
									<div class="form-row row-piece">
										...
										<div class="col-md-3">
											<div class="position-relative form-group">
												...
												{!! Form::select('theme[][]', $optionscolor, old('theme[][]'), ['class' => 'form-control selectpicker select-theme']) !!}
