		...
		<div class="app-header-left">
			<div class="search-wrapper">
				<div class="input-holder">
					<input type="text" class="search-input" placeholder="Busca rápida">
			...
			<ul class="header-menu nav">
				<li class="nav-item">
					<a href="javascript:void(0);" class="nav-link"><i class="nav-link-icon fa fa-database"></i> Estatísticas</a>
				</li>
				<li class="nav-item">
					<a href="javascript:void(0);" class="nav-link"><i class="nav-link-icon fa fa-cog"></i> Configurações</a>
				</li>
			</ul>
			{{-- <ul class="header-menu body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
				<li class="nav-item">
				...
				<div class="widget-content p-0">
					<div class="widget-content-wrapper">
						<div class="widget-content-left">
							<div class="btn-group">
								{{-- <a href="{!! route('profile') !!}" class="btn ml-3 mr-3">
									{!! Auth::user()->name !!}
								</a>
								<button type="button" class="btn-shadow p-1 btn btn-danger btn-sm logout btn-logout">
									<i class="fas fa-sign-out-alt text-white pr-1 pl-1"></i>
								</button> --}}
